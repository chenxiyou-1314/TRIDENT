ALL_ID_DATASET = [
    # far task
    'cifar10', 'cifar100', 'bird200', 'car196', 'food101', 'pet37', 'ImageNet', 'ImageNet_sketch', 'boat29',
    # near task
    'ImageNet10', 'ImageNet20',
    # fine_grained task
    'cub100_ID', 'car98_ID', 'food50_ID', 'pet18_ID', 'boat14_ID',
    # explore the robustness
    'ImageNet_C_blur_defocus_blur', 'ImageNet_C_blur_glass_blur', 'ImageNet_C_blur_motion_blur',
    'ImageNet_C_blur_zoom_blur',
    'ImageNet_C_digital_contrast', 'ImageNet_C_digital_elastic_transform', 'ImageNet_C_digital_jpeg_compression',
    'ImageNet_C_digital_pixelate',
    'ImageNet_C_extra_gaussian_blur', 'ImageNet_C_extra_saturate', 'ImageNet_C_extra_spatter',
    'ImageNet_C_extra_speckle_noise',
...
ALL_LLM = [
    'claude-3-5-sonnet-20241022', 'gpt-3.5-turbo', 'gpt-3.5-turbo-16k', 'gpt-4', 'gpt-4-vision-preview', 'gpt-4-0125-preview', 'gpt-4o',
    'Claude-2', 'Claude-2-100k', 'Claude-3-Haiku', 'qwen-vl-plus', 'qwen2-vl-2b-instruct', 'gemini-1.5-flash', 'gemini-2.0-flash',
    ...
    'Llama-2-7b', 'Llama-2-13b', 'Llama-2-70b', 'claude-3-5-sonnet-20240620',
...
dataset_mappings = {
    ...
    'boat29': ['iNaturalist', 'SUN', 'places365', 'dtd'],
