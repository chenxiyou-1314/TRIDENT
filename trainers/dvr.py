...
CUSTOM_TEMPLATES = {
    ...
    "OxfordPets_18": "a photo of a {}, a type of pet.",
    "OxfordFlowers": "a photo of a {}, a type of flower.",
    "FGVCAircraft": "a photo of a {}, a type of aircraft.",
    "DescribableTextures": "{} texture.",
    "EuroSAT": "a centered satellite photo of {}.",
    "StanfordCars": "a photo of a {}, a type of car.",
    "StanfordCars_98": "a photo of a {}, a type of car.",
    "Food101": "a photo of {}, a type of food.",
    "Food101_50": "a photo of {}, a type of food.",
    "SUN397": "a photo of a {}.",
    ...
    "Boat29": "a photo of a {}, a type of boat.",
    "Boat29_14": "a photo of a {}, a type of boat",
    "CUB200": "a photo of a {}, a type of bird",
    "CUB200_100": "a photo of a {}, a type of bird",
}
...
def _get_base_text_features(cfg, classnames, clip_model, text_encoder):
    ...
    if dataset not in CUSTOM_TEMPLATES:
        raise KeyError(f"The '{dataset}' key cannot be found in CUSTOM_TEMPLATES. Please check if the dataset name is correct!")
    if dataset == "ImageNet":
...
class CustomCLIP(nn.Module):
    def __init__(self, cfg, classnames, clip_model):
        ...
        if cfg.TRAINER.DVR.ENHANCED_BASE == "none":
            ...
            base_text_features = _get_enhanced_base_text_features(
                cfg, classnames, clip_model, text_encoder, cfg.TRAINER.DVR.ENHANCED_BASE)

        self.prompt_learner = DVRLearner(cfg, classnames, clip_model, base_text_features)
...
class DVR(TrainerX):
    ...
    def check_cfg(self, cfg):
        assert cfg.TRAINER.DVR.PREC in ["fp16", "fp32", "amp"]
    ...
    def build_model(self):
        ...
        if cfg.TRAINER.DVR.PREC == "fp32" or cfg.TRAINER.DVR.PREC == "amp":
        ...
        self.scaler = GradScaler() if cfg.TRAINER.DVR.PREC == "amp" else None
    ...
    def forward_backward(self, batch):
        ...
        prec = self.cfg.TRAINER.DVR.PREC
        if prec == "amp":
            with autocast():
